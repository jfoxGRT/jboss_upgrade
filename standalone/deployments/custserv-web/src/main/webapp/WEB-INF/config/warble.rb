...
Warbler::Config.new do |config|
  ...
  # config.gems << "tzinfo"
  config.gems += ["fastercsv", "httpclient", "rails_sql_views", "rspec", "soap4r", "will_paginate", "activerecord-jdbc-adapter", "activerecord-jdbcmysql-adapter", "jdbc-mysql", "jruby-openssl"]
